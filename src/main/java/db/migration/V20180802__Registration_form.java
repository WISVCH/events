 ...
 */
public class V20180802__Registration_form implements SpringJdbcMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        jdbcTemplate.execute(profileTable);
        ...
        jdbcTemplate.execute(registrationTable);
        ...
        jdbcTemplate.execute(studyDetailsTable);
        ...
        jdbcTemplate.execute("ALTER TABLE public.product ADD ch_only boolean DEFAULT false NOT NULL;");
        jdbcTemplate.execute("ALTER TABLE public.product ADD includes_registration boolean DEFAULT false NOT NULL;");
    }
}
